  ...
  return (
    <div className="min-h-screen bg-black">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="block text-cyan-400 mt-2">Ecosystem</span>
              </h1>
            ...
            <div className="relative">
              <div className="relative mx-auto w-80 h-[600px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-[3rem] border-8 border-gray-700 shadow-2xl overflow-hidden">
                ...
                {/* Screen Content */}
                <div className="h-full bg-gradient-to-br from-cyan-500/20 to-purple-500/20 p-8 pt-12">
                  <div className="text-center mb-8">
                    <div className="w-20 h-20 mx-auto bg-cyan-500 rounded-3xl flex items-center justify-center mb-4">
                      <Shield className="text-black" size={40} />
                    </div>
                    <h3 className="text-white text-xl font-bold">SEC@R</h3>
                    <p className="text-cyan-400 text-sm">Consent Controller</p>
                  </div>

                  <div className="space-y-4">
                    <div className="bg-black/40 backdrop-blur rounded-xl p-4 border border-cyan-500/30">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <div className="w-10 h-10 bg-cyan-500/30 rounded-lg flex items-center justify-center">
                            <Bluetooth className="text-cyan-400" size={20} />
                          </div>
                          <div>
                            <div className="text-white text-sm font-semibold">BLE Devices</div>
                            <div className="text-cyan-400 text-xs">8 devices detected</div>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-cyan-400 text-xs">Verified</div>
                          </div>
                        </div>
                        <Check className="text-cyan-400" size={20} />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-cyan-400 text-xs">No threats</div>
                          </div>
                        </div>
                        <Check className="text-cyan-400" size={20} />
                      </div>
                  ...
                  <Button className="w-full mt-8 bg-cyan-500 hover:bg-purple-600 text-black font-semibold">
                    Approve Transaction
                  </Button>
                </div>
              </div>
      ...
      <section className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">Powerful Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {appFeatures.map((feature, index) => {
              ...
              return (
                <Card key={index} className="bg-gray-900/50 border-gray-800 hover:border-cyan-500/50 transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="w-14 h-14 mb-4 bg-cyan-500/20 rounded-xl flex items-center justify-center">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Consent <span className="text-cyan-400">Controller</span>, Not Manager
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="bg-cyan-500/5 border-cyan-500/30">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start space-x-2">
                    <Check className="text-cyan-400 mt-1 flex-shrink-0" size={16} />
      ...
      <section className="py-24 bg-gradient-to-b from-black to-gray-950">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">Backend Architecture</h2>
            <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
                ...
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-4 bg-cyan-500/20 rounded-2xl flex items-center justify-center">
                ...
                <div className="flex justify-center">
                  <ArrowRight className="text-cyan-400 hidden md:block" size={32} />
                </div>
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">API Architecture</h2>
            <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">POST /api/consent/request</code>
                    <p className="text-gray-400 text-xs mt-2">Initiate consent verification request</p>
                  </div>
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">GET /api/consent/status</code>
                    <p className="text-gray-400 text-xs mt-2">Check consent verification status</p>
                  </div>
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">POST /api/device/verify</code>
                    <p className="text-gray-400 text-xs mt-2">Verify device authenticity and health</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">POST /api/transaction/authorize</code>
                    <p className="text-gray-400 text-xs mt-2">Request transaction authorization</p>
                  </div>
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">POST /api/identity/verify</code>
                    <p className="text-gray-400 text-xs mt-2">Verify Data Principal identity</p>
                  </div>
                  <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                    <code className="text-cyan-400 text-sm">POST /api/webhook/register</code>
      ...
      <section className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">API Integrations</h2>
            <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">
                ...
                <Card key={index} className="bg-gray-900/50 border-gray-800 hover:border-cyan-500/50 transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="flex items-center text-white">
                      <div className="w-12 h-12 mr-4 bg-cyan-500/20 rounded-xl flex items-center justify-center">
