    ...
    <section id="testimonials" className="py-24 bg-gradient-to-b from-black to-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-emerald-400 uppercase tracking-wider mb-4">Testimonials</h2>
            ...
            >
              <CardContent className="p-8 relative">
                ...
                <div className="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                  <Quote size={64} className="text-emerald-400" />
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <Avatar className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-teal-600">
