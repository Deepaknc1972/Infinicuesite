    ...
    <section className="py-24 bg-gradient-to-b from-gray-950 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">Threats Prevented</h2>
            ...
            return (
              ...
              >
                <CardContent className="p-6">
                  {/* Icon */}
                  <div className="w-14 h-14 mb-4 bg-red-500/10 rounded-xl flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors duration-300">
                    <Icon className="text-red-400 group-hover:text-cyan-400 transition-colors duration-300" size={28} />
                  </div>
