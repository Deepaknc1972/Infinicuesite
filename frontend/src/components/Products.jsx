    ...
    <section id="products" className="py-24 bg-gradient-to-b from-gray-950 to-black">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-emerald-400 uppercase tracking-wider mb-4">Products</h2>
            ...
            >
              {product.badge && (
                <div className="absolute top-0 right-0">
                  <Badge className="bg-emerald-500 text-black font-semibold rounded-tl-none rounded-br-none">
                    {product.badge}
                  </Badge>
                </div>
              )}
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  className="w-full bg-emerald-500 hover:bg-emerald-600 text-black font-semibold mt-6"
