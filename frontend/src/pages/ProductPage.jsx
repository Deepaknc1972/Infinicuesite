              ...
              <Card className="glass overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-cyan-400 uppercase mb-2">Price</h4>
                      <p className="text-2xl font-bold text-white">{selectedProduct.price}</p>
                    </div>
                    
                    <div>
                      <h4 className="text-sm font-semibold text-cyan-400 uppercase mb-2">Availability</h4>
                  ...
                  <div className="flex gap-4 mt-8">
                    <Button 
                      className="flex-1 bg-cyan-500 hover:bg-purple-600 text-black font-semibold"
            ...
            <div>
              <Tabs defaultValue="features" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-gray-900 border border-gray-800">
                  <TabsTrigger value="features" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-black">
                    Features
                  </TabsTrigger>
                  <TabsTrigger value="specs" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-black">
                    Specifications
                  </TabsTrigger>
                  <TabsTrigger value="security" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-black">
                    Security
                  </TabsTrigger>
                </TabsList>
                  ...
                  <Card className="bg-gray-900/50 border-gray-800">
                    ...
                    <CardContent className="space-y-4">
                      {selectedProduct.security.map((item, idx) => (
                        <div key={idx} className="flex items-start space-x-3 p-4 bg-cyan-500/5 rounded-lg border border-cyan-500/20">
