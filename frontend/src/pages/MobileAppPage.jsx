          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative mx-auto w-80 h-[600px] bg-gradient-to-br from-gray-900 to-gray-800 rounded-[3rem] border-8 border-gray-700 shadow-2xl overflow-hidden">
                ...
                {/* Screen Content */}
                <div className="h-full bg-gradient-to-br from-green-500/20 to-purple-500/20 p-8 pt-12">
                  ...
                  <Button className="w-full mt-8 bg-green-500 hover:bg-purple-600 text-black font-semibold">
                    Approve Transaction
                  </Button>
                </div>
              </div>
