    ...
    <section id="testimonials" className="py-24 bg-gradient-to-b from-black to-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-4">Testimonials</h2>
              ...
              <CardContent className="p-8 relative">
                ...
                <div className="flex items-center space-x-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="text-cyan-400 fill-cyan-400" size={18} />
                  ))}
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <Avatar className="w-12 h-12 bg-gradient-to-br from-cyan-400 to-purple-600">
