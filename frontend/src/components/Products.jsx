            ...
            >
              {product.badge && (
                <div className="absolute top-0 right-0">
                  <Badge className="bg-green-500 text-black font-semibold rounded-tl-none rounded-br-none">
                    {product.badge}
                  </Badge>
                </div>
              )}
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  className="w-full bg-green-500 hover:bg-purple-600 text-black font-semibold mt-6"
