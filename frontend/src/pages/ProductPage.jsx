              ...
              <Card className="bg-gray-900/50 border-gray-800 overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-emerald-400 uppercase mb-2">Price</h4>
                      <p className="text-2xl font-bold text-white">{selectedProduct.price}</p>
                    </div>
                    
                    <div>
                      <h4 className="text-sm font-semibold text-emerald-400 uppercase mb-2">Availability</h4>
            ...
            <div>
              <Tabs defaultValue="features" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-gray-900 border border-gray-800">
                  <TabsTrigger value="features" className="data-[state=active]:bg-emerald-500 data-[state=active]:text-black">
                    Features
                  </TabsTrigger>
                  <TabsTrigger value="specs" className="data-[state=active]:bg-emerald-500 data-[state=active]:text-black">
                    Specifications
                  </TabsTrigger>
                  ...
                  <Card className="bg-gray-900/50 border-gray-800">
                    ...
                    <CardContent className="space-y-4">
                      {selectedProduct.security.map((item, idx) => (
                        <div key={idx} className="flex items-start space-x-3 p-4 bg-emerald-500/5 rounded-lg border border-emerald-500/20">
              ...
              {/* Use Cases */}
              <Card className="mt-6 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border-emerald-500/30">
                <CardHeader>
