      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 glass-emerald rounded-full px-6 py-2 mb-6">
            ...
            <span className="text-purple-400 font-medium">API-Driven Architecture</span>
          </div>
              ...
              return (
                <div key={index} className="relative">
                  <Card className={`glass hover:scale-105 transition-all duration-300 ${
                    step.color === 'cyan' ? 'border-purple-500/30' : 'border-purple-500/30'
                  }`}>
                    <CardContent className="p-6">
                      {/* Step Number */}
                      <div className={`absolute -top-3 -right-3 w-10 h-10 rounded-full flex items-center justify-center font-bold text-black ${
                        step.color === 'cyan' ? 'bg-gradient-to-br from-purple-400 to-purple-600' : 'bg-gradient-to-br from-purple-500 to-purple-700'
                      }`}>
                        {step.step}
                      </div>
                      ...
                      <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center ${
                        step.color === 'cyan' ? 'bg-purple-500/20' : 'bg-purple-500/20'
                      }`}>
                        <Icon className={step.color === 'cyan' ? 'text-purple-400' : 'text-purple-400'} size={32} />
                      </div>

                      {/* Content */}
                      <h4 className="text-lg font-bold text-white text-center mb-2">{step.title}</h4>
                      <p className={`text-center mb-2 font-medium ${
                        step.color === 'cyan' ? 'text-purple-400' : 'text-purple-400'
                      }`}>
                        {step.description}
                      </p>
          ...
          <Card className="glass-gradient border-purple-500/30">
            <CardHeader>
              <CardTitle className="text-3xl text-white flex items-center justify-center">
                <Layers className="text-purple-400 mr-3" size={32} />
            ...
            <CardContent className="p-8">
              ...
              <div className="bg-black/40 rounded-xl p-6 border border-purple-500/20">
                ...
                <p className="text-gray-300 mb-4">
                  ...
                  for exactly <span className="text-purple-400 font-bold">180 seconds (3 minutes)</span>. This time-limited 
                  window ensures:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start space-x-2">
                    <CheckCircle2 className="text-purple-400 flex-shrink-0 mt-1" size={16} />
                ...
                <Card key={index} className="glass hover:scale-105 transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="flex items-center text-white">
                      <div className="w-12 h-12 mr-4 bg-gradient-to-br from-purple-500/20 to-purple-500/20 rounded-xl flex items-center justify-center">
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-2">
                      <div className="text-purple-400 text-xs font-semibold mb-2">Key Endpoints:</div>
                      {integration.endpoints.map((endpoint, idx) => (
                        <div key={idx} className="bg-black/40 rounded p-2 border border-purple-500/10">
                          <code className="text-purple-400 text-xs">{endpoint}</code>
                        </div>
                      ))}
                    </div>
                  </CardContent>
          ...
          <Card className="glass-strong">
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-gradient-to-br from-purple-500/10 to-purple-500/10 rounded-xl border border-white/10">
                  <div className="text-3xl font-bold text-purple-400 mb-2">&lt;100ms</div>
                  <div className="text-sm text-gray-400">API Response Time</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-purple-500/10 to-purple-500/10 rounded-xl border border-white/10">
                  <div className="text-3xl font-bold text-purple-400 mb-2">180s</div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-purple-500/10 to-purple-500/10 rounded-xl border border-purple-500/20">
                <h5 className="text-white font-bold mb-3 flex items-center">
                  <AlertCircle className="text-purple-400 mr-2" size={20} />
                  Security Features
                </h5>
