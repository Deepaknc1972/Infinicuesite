      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-black via-gray-950 to-black relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 20% 50%, rgba(50, 158, 236, 0.47) 0%, transparent 50%),
                             radial-gradient(circle at 80% 50%, rgba(47, 185, 236, 0.3) 0%, transparent 50%)`
          }}></div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-purple-500 pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="glass text-center p-8 hover:scale-105 transition-all duration-300">
                <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-purple-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center text-purple-400">
                  {value.icon}
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="glass-strong rounded-2xl p-12 text-center">
              ...
              <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-500 mb-6">
