                  ...
                  <Card className="glass-gradient border-cyan-500/30">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 rounded-xl p-4">
                        <div className="text-sm font-semibold text-cyan-400 mb-2">Result:</div>
          ...
          <Card className="glass-strong border-cyan-500/30">
            <CardContent className="p-12 text-center">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white font-semibold px-12 py-4 rounded-lg text-lg transition-all duration-300 hover:scale-105"
              >
                Get Started Today
              </button>
            </CardContent>
