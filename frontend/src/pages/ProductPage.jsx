        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <Card className="glass overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex gap-4 mt-8">
                    <Button 
                      className="flex-1 bg-green-500 hover:bg-purple-600 text-black font-semibold"
            ...
            <div>
              ...
              {/* Use Cases */}
              <Card className="mt-6 bg-gradient-to-r from-green-500/10 to-purple-500/10 border-green-500/30">
                <CardHeader>
