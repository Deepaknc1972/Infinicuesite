    ...
    <section id="contact" className="py-24 bg-gray-950">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-purple-400 uppercase tracking-wider mb-4">Contact Us</h2>
            ...
            <Card className="glass hover:scale-105">
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href={`tel:${contactInfo.phone}`} className="text-gray-400 hover:text-purple-400 transition-colors">
                    {contactInfo.phone}
                  </a>
                </div>
              </CardContent>
          ...
          <Card className="lg:col-span-2 glass-strong">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-purple-500 hover:bg-purple-600 text-black font-semibold py-6 text-lg group"
                >
                  Send Message
