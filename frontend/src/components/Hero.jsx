    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black pt-20">
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        <div className="inline-flex items-center space-x-2 glass-emerald rounded-full px-6 py-2 mb-8 animate-fade-in">
          ...
          <span className="text-cyan-400 font-medium">SEC@R - Consent at Real-Time</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <Button 
            size="lg" 
            className="bg-cyan-500 hover:bg-purple-600 text-black font-semibold px-8 py-6 text-lg group"
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-gray-400 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center space-x-2 glass px-4 py-2 rounded-full">
            <div className="w-6 h-6 bg-cyan-500/20 rounded flex items-center justify-center text-cyan-400 text-xs font-bold">✓</div>
